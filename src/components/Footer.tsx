...
const socialLinks = [
  ...
  },
  {
    label: "WhatsApp",
    href: "#",
    // TODO: Replace # with client WhatsApp link when provided
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61591289801041",
    path: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/nexorafunding/",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10 border-b border-white/10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            {/* TODO: Replace with client's final phone number */}
          ...
          <div>
            <h3 className="text-white font-semibold text-sm mb-5">Business Finance</h3>
          ...
          <div>
            ...
            {/* Social icons — Twitter/X removed; WhatsApp + Instagram added */}
        ...
        {/* Copyright bar */}
        <div className="py-5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
